...
class Fuzzy:
    ...
    def interpret(self, ensemble_results: dict, local_results: dict, data: TabularData):
        ...
        # n_rows = n_samples * n_models * n_folds * n_fi_types.
        # If there are 100 samples used to train 2 models over 10 folds
        # and they're assessed with LIME and SHAP, n_rows = 100 * 2 * 10 * 2 = 4000.
